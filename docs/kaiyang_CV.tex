...
\item {\bf{K. Yang}}, T. Jiang, Y. Shi, and Z. Ding, ``Federated learning via over-the-air computation,'' \emph{IEEE Trans. Wireless Commun.}, to appear.
\item {\bf{K. Yang}}, Y. Shi, and Z. Ding, ``Data shuffling in wireless distributed computing via low-rank optimization,"
\emph{IEEE Trans. Signal Process.}, \emph{IEEE Trans. Signal Process.}, vol. 67, no. 12, pp. 3087-3099, Jun. 2019.
